var checkForInitialization = function() {
	...
	if(localStorage["toggle_pause"]) {
		localStorage.removeItem("toggle_pause");
	}
	...
	if (!localStorage["frame_supported_sites"]) {
		localStorage["frame_supported_sites"] = "stumbleupon.com;";
	}
}
...
var forceInitializeSettings = function() {
	...
	localStorage.removeItem("frame_supported_sites");
