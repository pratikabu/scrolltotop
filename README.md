# <img valign="middle" style="vertical-align: middle;" src="src/icons/pratikabu-stt-single-1.png" width="36px"> Scroll To Top
...
- Icon refrerence [here](resources/README.md#icon-sources).
